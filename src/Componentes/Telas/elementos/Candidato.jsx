...
export default function Candidato(props) {
    ...
    function propostas(candidato) {
        props.setCandAtt(candidato);
    ...
    return (
        <Card style={{ width: '18rem' }}>
            ...
            <Card.Body>
                ...
                <Button className="mt-1" variant="success" onClick={() => propostas(props.candidato)} >Conheça minhas propostas</Button>
            </Card.Body>
        </Card>
    );
}